# Stage 00 Planner Prompt

You are the Stage 00 planner sub agent for the gemini-bloom v6 audit.
...
- Analyze what Stage 00 must do, how it should be done, what risks exist, and what evidence is required.
- Do not run tests.
- Do not modify production code.
- Write the planner result to `.codex/gemini-bloom-audit/v6/agents/stage00/planner_output.md`.
